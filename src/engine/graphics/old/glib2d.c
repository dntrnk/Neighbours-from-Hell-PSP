...
#define DEFAULT_PALLETE GU_PSM_8888
...
void g2dInit()
{
  ...
  sceGuDrawBuffer(DEFAULT_PALLETE,g2d_draw_buffer.data,PSP_LINE_SIZE);
...
void g2dEnd()
{
  ...
  else
  {
    ...
    // Load texture
    sceGuTexMode(DEFAULT_PALLETE,0,0,obj_tex->swizzled);
